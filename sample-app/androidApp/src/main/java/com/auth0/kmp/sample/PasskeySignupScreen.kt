...
fun PasskeySignupScreen(
    ...
    Column(
        ...
        PasskeyField(label = "Connection (database)") {
            OutlinedTextField(
                value = connection,
        ...
        Button(
            onClick = {
                onRegister(email, connection) { options ->
                    PasskeyCeremony.register(context, options)
                }
            },
...
@Composable
private fun PasskeyField(label: String, field: @Composable () -> Unit) {
