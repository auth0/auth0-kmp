...
class DefaultAuthenticationClientTest {
    ...
    fun passwordlessWithEmail_success_buildsStartRequest() = runTest {
        ...
        val result = impl.passwordlessWithEmail(email = "a@b.com")
    ...
    fun passwordlessWithEmail_blankEmail_failsWithoutNetworkCall() = runTest {
        ...
        val result = impl.passwordlessWithEmail(email = " ")
    ...
    fun passwordlessWithEmail_blankConnection_failsWithoutNetworkCall() = runTest {
        ...
        val result = impl.passwordlessWithEmail(email = "a@b.com", connection = " ")
    ...
    fun passwordlessWithSMS_success_buildsStartRequest() = runTest {
        ...
        val result = impl.passwordlessWithSMS(phoneNumber = "+15551234567")
    ...
    fun passwordlessWithSMS_blankPhoneNumber_failsWithoutNetworkCall() = runTest {
        ...
        val result = impl.passwordlessWithSMS(phoneNumber = " ")
    ...
    fun loginWithEmail_success_buildsPasswordlessGrant_andValidatesIdToken() = runTest {
        ...
        val result = impl.loginWithEmail(email = "a@b.com", code = "123456", scope = "openid")
        ...
        assertEquals("openid", params.str("scope"))
        assertEquals(ID_TOKEN, deps.second.lastIdToken)
    }

    @Test
    fun loginWithSMS_success_buildsPasswordlessGrant_withSmsRealm() = runTest {
        val (impl, deps) = client(Result.Success(credentials()))

        impl.loginWithSMS(phoneNumber = "+15551234567", code = "123456")
    ...
    fun loginWithEmail_includesAudience_whenProvided() = runTest {
        ...
        impl.loginWithEmail(email = "a@b.com", code = "123456", audience = "https://api")
    ...
    fun loginWithEmail_blankCode_failsWithoutBuildingGrant() = runTest {
        ...
        val result = impl.loginWithEmail(email = "a@b.com", code = " ")
    ...
    @Test
    fun loginWithSMS_blankPhoneNumber_failsWithoutBuildingGrant() = runTest {
        val (impl, deps) = client(Result.Success(credentials()))

        val result = impl.loginWithSMS(phoneNumber = " ", code = "123456")
    ...
    fun loginWithEmail_invalidIdToken_failsWithIdTokenValidation() = runTest {
        ...
        val result = impl.loginWithEmail(email = "a@b.com", code = "123456")
    ...
    @Test
    fun loginWithEmail_serverError_mapsToApiError() = runTest {
        val server = TransportError.Server(
            403,
        ...
        assertEquals(
            Result.Failure(AuthenticationError.ApiError("invalid_grant", "Wrong code", 403)),
            result,
        )
    }
