package com.auth0.core.result

import com.auth0.core.error.Auth0Error
...
class ResultTest {
    ...
    @Test
    fun errorOrNull_returnsError_onFailure() {
    ...
    @Test
    fun errorOrNull_returnsNull_onSuccess() {
        val result: Result<Int, FakeError> = Result.Success(1)
